...
<p>Additional extension plugins are also available for WPSSO, including <a href="https://wordpress.org/plugins/wpsso-am/">WPSSO App Meta</a>, <a href="https://wordpress.org/plugins/wpsso-plm/">WPSSO Place and Location Meta</a>, and <a href="https://wordpress.org/plugins/wpsso-ssb/">WPSSO Social Sharing Buttons</a>.</p>
</blockquote>
...
<ul>
	<li><strong><font color="blue">0.0050</font></strong> secs - WPSSO Social Sharing Buttons (SSB) v1.1</li>
	<li><strong><font color="blue">0.0116</font></strong> secs - <a href="https://wordpress.org/plugins/wpsso/">WordPress Social Sharing Optimization (WPSSO) v2.7.1</a></li>
	...
	<li><strong><font color="blue">0.0186</font></strong> secs - <em><strong>NextGEN Facebook (NGFB) v7.7.1</strong></em></li>
...
2. An Example Facebook Link Share
3. An Example Facebook Video Share
4. An Example Google+ Link Share
5. An Example Google+ Video Share
6. An Example Google Search Result showing Author Profile Info
7. An Example LinkedIn Share
8. An Example Pinterest Image Pin
9. An Example Pinterest Product Pin
10. An Example Pinterest Product Pin (Zoomed)
11. An Example StumbleUpon Share
12. An Example Tumblr 'Link' Share
13. An Example Tumblr 'Photo' Share
14. An Example Tumblr 'Video' Share
15. An Example Twitter 'Summary' Card
16. An Example Twitter 'Large Image Summary' Card
17. An Example Twitter 'Photo' Card
18. An Example Twitter 'Gallery' Card
19. An Example Twitter 'Product' Card
