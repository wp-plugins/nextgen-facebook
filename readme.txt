...
The floating sidebar hooks into the `wp_footer()` action, which means you can also transform the sidebar into a non-floating footer component by removing or changing the <em>position</em>, <em>top</em>, <em>right</em>, and <em>margin</em> CSS properties in the Sidebar Style tab.
