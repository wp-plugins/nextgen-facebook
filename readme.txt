...
&lt;meta property="fb:admins" content="" /$gt;
...
&lt;meta property="article:author" content="Jean-Sebastien Morisset" /$gt;
...
* Added the category description (if there is one) to the Open Graph description meta tag.
* Added the category parents (if any) to the Open Graph title meta tag.
