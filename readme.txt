...
NGFB Open Graph+ adds HTML tags (Open Graph, Rich Pins, Twitter Cards) to the head section of your webpages for improved Google Search results, and sharing on Facebook, Google+, Twitter, LinkedIn, Pinterest, StumbleUpon, Tumblr and many more -- an essential plugin for every WordPress website!
