...
NGFB Open Graph+ adds header HTML tags (Open Graph, Twitter Cards and Rich Pins) to your webpages for improved Google Search results and sharing on Facebook, Google+, Twitter, LinkedIn, Pinterest, StumbleUpon, Tumblr and many more -- an essential plugin for every WordPress website!
...
* Added support for multisite network-wide activate, deactivate, and uninstall.
