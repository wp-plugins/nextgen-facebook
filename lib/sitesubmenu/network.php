...
if ( ! class_exists( 'NgfbSitesubmenuNetwork' ) && class_exists( 'NgfbAdmin' ) ) {

	class NgfbSitesubmenuNetwork extends NgfbAdmin {
		...
		protected function get_rows( $metabox, $key ) {
			...
			switch ( $metabox.'-'.$key ) {
				case 'network-settings' :
					...
					'<td nowrap>Site Use <img src="'.NGFB_URLPATH.'images/question-mark.png" class="sucom_tooltip'.'" alt="'.$use_msg.'" /> '.
