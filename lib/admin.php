...
<p>You can also contribute by <a href="http://wordpress.org/support/view/plugin-reviews/nextgen-facebook" target="_blank">giving NGFB a positive review and rating of 5 stars</a>.</p>
			...
			<p>The images listed in the Open Graph image property tags are chosen in this sequence: a featured image from a NextGEN Gallery or WordPress Media Library, images from NextGEN Gallery <code>[singlepic]</code>, <code>[nggallery]</code> or <code>[nggtags]</code> shortcodes, images from <code>&lt;img/&gt;</code> HTML tags in the Post or Page content text, a default image defined in the NGFB plugin settings. <?php echo NGFB_ACRONYM; ?> can detect images of varying sizes, embedded videos, and include one or more of each in your Open Graph property tags.</p>
