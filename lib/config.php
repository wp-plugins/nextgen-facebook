...
if ( ! class_exists( 'NgfbConfig' ) ) {
	...
	class NgfbConfig {
		...
		private static $cf = array(
			...
			'opt' => array(				// options
				'version' => '246',		// increment when changing default options
				'defaults' => array(
					'meta_desc_len' => 157,
					'link_author_field' => '',
					...
					'buttons_pos_the_content' => 'bottom',
					'buttons_pos_the_excerpt' => 'bottom',
...
jQuery("#ngfb-sidebar").click( function(){ jQuery("#ngfb-sidebar-buttons").toggle(); } );',
					'buttons_preset_the_content' => '',
					'buttons_preset_the_excerpt' => '',
