...
if ( ! class_exists( 'NgfbConfig' ) ) {
	...
	class NgfbConfig {
		...
		private static $cf = array(
			'version' => '7.4.4dev1',		// plugin version
			...
			'opt' => array(				// options
				'version' => '271',		// increment when changing default options
				'defaults' => array(
					...
					'meta_property_fb:admins' => 1,
					'meta_property_fb:app_id' => 1,
					'meta_property_og:locale' => 1,
					'meta_property_og:site_name' => 1,
					'meta_property_og:description' => 1,
					'meta_property_og:title' => 1,
					'meta_property_og:type' => 1,
					'meta_property_og:url' => 1,
					'meta_property_og:image' => 1,
					'meta_property_og:image:secure_url' => 1,
					'meta_property_og:image:width' => 1,
					'meta_property_og:image:height' => 1,
					'meta_property_og:video' => 1,
					'meta_property_og:video:secure_url' => 1,
					'meta_property_og:video:width' => 1,
					'meta_property_og:video:height' => 1,
					'meta_property_og:video:type' => 1,
					'meta_property_article:author' => 1,
					'meta_property_article:publisher' => 1,
					'meta_property_article:published_time' => 1,
					'meta_property_article:modified_time' => 1,
					'meta_property_article:section' => 1,
					'meta_property_article:tag' => 1,
					'meta_property_product:price:amount' => 1,
					'meta_property_product:price:currency' => 1,
					'meta_property_product:availability' => 1,
					'meta_name_twitter:card' => 1,
					'meta_name_twitter:creator' => 1,
					'meta_name_twitter:site' => 1,
					'meta_name_twitter:title' => 1,
					'meta_name_twitter:description' => 1,
					'meta_name_twitter:image' => 1,
					'meta_name_twitter:image:width' => 1,
					'meta_name_twitter:image:height' => 1,
					'meta_name_twitter:image0' => 1,
					'meta_name_twitter:image1' => 1,
					'meta_name_twitter:image2' => 1,
					'meta_name_twitter:image3' => 1,
					'meta_name_twitter:player' => 1,
					'meta_name_twitter:player:width' => 1,
					'meta_name_twitter:player:height' => 1,
					'meta_name_twitter:data1' => 1,
					'meta_name_twitter:label1' => 1,
					'meta_name_twitter:data2' => 1,
					'meta_name_twitter:label2' => 1,
					'meta_name_twitter:data3' => 1,
					'meta_name_twitter:label3' => 1,
					'meta_name_twitter:data4' => 1,
					'meta_name_twitter:label4' => 1,
					'meta_name_description' => 0,
					'meta_itemprop_description' => 1,
					'plugin_version' => '',
					'plugin_tid' => '',
					'plugin_preserve' => 0,
					'plugin_debug' => 0,
