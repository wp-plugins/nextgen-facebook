...
if ( ! class_exists( 'NgfbAdminGeneralGpl' ) && class_exists( 'NgfbAdminGeneral' ) ) {

	class NgfbAdminGeneralGpl extends NgfbAdminGeneral {
...
if ( ! class_exists( 'NgfbAdminAdvancedGpl' ) && class_exists( 'NgfbAdminAdvanced' ) ) {

	class NgfbAdminAdvancedGpl extends NgfbAdminAdvanced {
