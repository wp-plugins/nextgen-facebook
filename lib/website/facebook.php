		...
		public function get_rows( $id ) {
			...
			switch ( $id ) {
				...
				case 'all' :
					...
					'Content '.$this->form->get_checkbox( 'fb_on_the_content' ).'&nbsp;'.
					'Excerpt '.$this->form->get_checkbox( 'fb_on_the_excerpt' ).'&nbsp;'.
					'Edit Post/Page '.$this->form->get_checkbox( 'fb_on_admin_sharing' ). 
					'</td>';
