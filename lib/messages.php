				...
				case ( strpos( $idx, 'info-' ) !== false ? true : false ):
					switch ( $idx ) {
						...
						case 'info-review':
							...
							<a href="'.$this->p->cf['url']['review'].'" target="_blank">rate the '.NgfbConfig::get_config( 'full' ).' plugin on WordPress.org</a>.</p>
							<p><strong>Your rating will help other WordPress users find higher quality and better supported plugins</strong> &mdash; 
							<em>and encourage us to keep improving '.NgfbConfig::get_config( 'full' ).' as well!</em> :)</p>
							<p>Thank you,</p>
							<p class="sig">js.</p>';
							break;
