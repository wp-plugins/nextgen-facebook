		...
		public function get( $idx = '', $atts = null, $class = '' ) {
			...
			switch ( $idx ) {
				...
				case 'review-info':
					...
					<a href="'.$this->p->cf['url']['review'].'" target="_blank">rate the '.NgfbConfig::get_config( 'full' ).' plugin on WordPress.org</a>.
					<strong>Your rating will help other WordPress users find higher quality and better supported plugins</strong> &mdash; 
					and encourage us to keep improving '.NgfbConfig::get_config( 'full' ).' at the same time!</p><p>Thank you. :)</p>';
					break;
				/*
				 * Other messages
				 */
