	...
	class ngfbAdminFacebook extends ngfbAdmin {
		...
		public function get_rows() {
			...
			return array(
				...
				'<th>Include Send Button</th><td>' . $this->checkbox( 'fb_send' ) . '</td>',
				'<th>Button Layout</th><td>' . $this->select( 'fb_layout', 
					array(
						'standard' => 'Standard',
				...
				'<th>Default Width</th><td>' . $this->input( 'fb_width', 'short' ) . '</td>',
				'<th>Show Faces</th><td>' . $this->checkbox( 'fb_show_faces' ) . '</td>',
				'<th>Button Font</th><td>' . $this->select( 'fb_font', 
					array( 
						'arial' => 'Arial',
				...
				'<th>Button Color Scheme</th><td>' . $this->select( 'fb_colorscheme', 
					array( 
						'light' => 'Light',
						'dark' => 'Dark',
					)
				) . '</td>',
				'<th>Facebook Action Name</th><td>' . $this->select( 'fb_action', 
					array( 
						'like' => 'Like',
						'recommend' => 'Recommend',
					)
