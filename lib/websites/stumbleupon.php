...
if ( ! class_exists( 'ngfbSettingsStumbleUpon' ) && class_exists( 'ngfbSettingsSocialSharing' ) ) {
	...
	class ngfbSettingsStumbleUpon extends ngfbSettingsSocialSharing {
		...
		public function get_rows() {
			...
			return array(
				'<th class="short">Add to Content Text</th><td>' . $this->ngfb->admin->form->get_checkbox( 'stumble_on_the_content' ) . '</td>',
				'<th class="short">Add to Excerpt Text</th><td>' . $this->ngfb->admin->form->get_checkbox( 'stumble_on_the_excerpt' ) . '</td>',
